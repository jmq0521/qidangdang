...
<style scoped>
  ...
  #hea-ul li:nth-of-type(2) p{border-radius: 15px;background: #ff5b00;}
  #hea-ul li:nth-of-type(3) p{border-radius: 15px;background: #cccccc;}
  #hea-ul li span{
    width: 20px;
    height: 20px;
    line-height: 20px;
  ...
  #hea-ul li:nth-child(2) a{color: #ff5b00;}
  #hea-ul li:nth-child(2) span{background: #ff5b00;}
